...
export const TAG_GROUPS: Record<string, string> = { role: 'Kişi rolü', event: 'Görüşme / işlem', site: 'Site / proje', rooms: 'Oda', transaction: 'Satılık / kiralık', sharing: 'Paylaşım durumu', source: 'Kaynak', stage: 'Takip aşaması', outcome: 'Sonuç', custom: 'Özel etiket' };
export const TAG_COLORS: Record<string, string> = {
 ...
 custom: 'bg-pink-100 text-pink-900 dark:bg-pink-900 dark:text-pink-100',
  ...
  sharing: 'bg-fuchsia-100 text-fuchsia-900 dark:bg-fuchsia-900 dark:text-fuchsia-100',
};
